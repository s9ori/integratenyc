...
final class SSO {
	...
	public function login_init() {
		...
		if ( ! $enabled || WP_DEBUG || ! Plugin::is_gd() || ! defined( 'GD_ACCOUNT_UID' ) || ! GD_ACCOUNT_UID || (bool) filter_input( INPUT_GET, 'wpaas-standard-login' ) || $this->is_plugin_hooked( 'login_form' ) || $this->is_plugin_hooked( 'login_enqueue_scripts' ) ) {
